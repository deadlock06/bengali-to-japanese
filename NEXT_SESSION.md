...
- **NEXT (vision gaps, ranked):** ① real-conversation stage (scenario/roleplay layer) ② voice-first STT (Tier-2 whisper alignment — device work) ③ vocab Phase-3 (say-it) + Phase-4 (word-blocks) ④ N4 content authoring (needs verified grammar + n4 whitelist) ⑤ yōon/sokuon/long-vowel kana.
